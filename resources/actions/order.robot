* Settings *
Documentation       Ações de funcionalidade de fechamento de pedido
...
Fill Data Customer
        ...
        Fill Text       css=input[placeholder="E-mail"]     ${customer["e-mail"]}   
        Fill Text       css=input[placeholder^="Confirmação"]     ${customer["e-mail"]}   
